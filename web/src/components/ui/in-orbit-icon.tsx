export function InOrbitIcon() {
  return (
    ...
    >
      ...
      <path
        d="M12 .5c-.936 0-1.847.107-2.72.31A12.016 12.016 0 00.31 9.78C.107 10.652 0 11.563 0 12.5c0 6.627 5.372 12 12 12 .935 0 1.846-.107 2.72-.31a12.017 12.017 0 008.97-8.968c.203-.875.31-1.786.31-2.722 0-6.627-5.373-12-12-12zm0 19.515a7.494 7.494 0 01-2.525-.435 7.536 7.536 0 01-4.555-4.555A7.515 7.515 0 1119.515 12.5 7.515 7.515 0 0112 20.015z"
      ...
      />
      <path
        d="M23.69 15.221a12.016 12.016 0 01-8.97 8.969 7.408 7.408 0 01-3.543-1.98 7.426 7.426 0 01-1.702-2.63 7.515 7.515 0 009.605-9.605c.959.362 1.858.93 2.63 1.702a7.41 7.41 0 011.98 3.544z"
